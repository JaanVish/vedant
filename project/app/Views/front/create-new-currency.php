                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-10">
                            <div class="main-content">
                                <h1>Create New Currency Bet</h1>
                                <div class="breadcrumb-area">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb d-flex align-items-center">
                                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                            <li class="breadcrumb-item"><a href="javascript:void(0)">Currency</a>
                                            </li>
                                            <li class="breadcrumb-item active" aria-current="page">Create New Currency
                                                Bet</li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="single-input">
                                            ...
                                            <div class="input-items d-flex">
                                                ...
                                                <input type="text" disabled value="Available 1.00 BTC">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <span class="btn-border">
                                            <a href="javascript:void(0)" class="cmn-btn">Create Currency Bet</a>
                                        </span>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="more-info">
