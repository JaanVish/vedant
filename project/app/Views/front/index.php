...
<section class="banner-section">
	<div class="overlay">
		<div class="shape-area">
			<img src="assets/backend/images/coin-2.png" class="obj-1" alt="image">
			<img src="assets/backend/images/winner-cup.png" class="obj-2" alt="image">
		</div>
		<div class="banner-content">
			<div class="container">
				<div class="content-shape">
					<img src="assets/backend/images/coin-1.png" class="obj-1" alt="image">
					<img src="assets/backend/images/coin-3.png" class="obj-2" alt="image">
					<img src="assets/backend/images/coin-3.png" class="obj-3" alt="image">
					<img src="assets/backend/images/coin-4.png" class="obj-4" alt="image">
				</div>
				<div class="row">
					<div class="col-lg-6 col-md-10">
						<div class="main-content">
							<div class="top-area section-text">
								<h4 class="sub-title">Play & Win Today!</h4>
								<h1 class="title">Vedant Games</h1>
								<p class="xlr">The fastest, easiest way to play and win through sports. 
									Choose the game to play and win</p>
							</div>
			...
			<div class="row cus-mar">
				<div class="col-xl-4 col-md-6">
					<div class="single-area d-flex align-items-center">
						<div class="img-area">
							<img src="assets/backend/images/icon/counter-icon-1.png" alt="image">
						</div>
						<div class="text-area">
				...
				<div class="col-xl-4 col-md-6">
					<div class="single-area d-flex align-items-center">
						<div class="img-area">
							<img src="assets/backend/images/icon/counter-icon-2.png" alt="image">
						</div>
						<div class="text-area">
				...
				<div class="col-xl-4 col-md-6">
					<div class="single-area d-flex align-items-center">
						<div class="img-area">
							<img src="assets/backend/images/icon/counter-icon-3.png" alt="image">
						</div>
						<div class="text-area">
...
<section class="about-bitbetio">
	<div class="overlay pt-120 pb-120">
		<div class="shape-area">
			<img src="assets/backend/images/crypto-fanus-1.png" class="obj-1" alt="image">
			<img src="assets/backend/images/crypto-fanus-2.png" class="obj-2" alt="image">
		</div>
		<div class="container">
			<div class="row d-flex align-items-end">
				<div class="col-lg-6">
					<div class="image-area d-rtl left-side">
						<img src="assets/backend/images/about-bitbetio-image.png" alt="images" class="max-un">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="section-text">
						<h5 class="sub-title">A Next-Level Online Gaming</h5>
						<h2 class="title">A Revolution in Online Gaming</h2>
						<p>Vedant Games is a user-friendly, decentralised, peer-to-peer gaming platform.</p>
					</div>
					<div class="row cus-mar">
						<div class="col-sm-6 col-6">
							<div class="single-item">
								<img src="assets/backend/images/icon/about-icon-1.png" alt="images">
								<h5>Peer-to-peer</h5>
							</div>
						</div>
						<div class="col-sm-6 col-6">
							<div class="single-item">
								<img src="assets/backend/images/icon/about-icon-2.png" alt="images">
								<h5>No limits</h5>
							</div>
						</div>
						<div class="col-sm-6 col-6">
							<div class="single-item">
								<img src="assets/backend/images/icon/about-icon-3.png" alt="images">
								<h5>Decentralised</h5>
							</div>
						</div>
						<div class="col-sm-6 col-6">
							<div class="single-item">
								<img src="assets/backend/images/icon/about-icon-4.png" alt="images">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="section-header text-center">
						...
						<h2 class="title">How Vedant Games Works?</h2>
						<p>Our platform has been designed from the ground up to be tailored to the unique form of
							gaming and winning. Follow these simple steps and make profits!</p>
					</div>
				</div>
			</div>
			<div class="main-content">
						...
						<ul class="nav" role="tablist">
							<li class="nav-item" role="presentation">
								<h5 class="nav-link active" id="sport-tab" data-bs-toggle="tab" data-bs-target="#sport" role="tab" aria-controls="sport" aria-selected="true">
									<span class="image-area">
										<img src="assets/backend/images/icon/how-works-icon-1.png" alt="icon">
									</span>
									Choose a game
								</h5>
							</li>
							<li class="nav-item" role="presentation">
								<h5 class="nav-link" id="match-tab" data-bs-toggle="tab" data-bs-target="#match" role="tab" aria-controls="match" aria-selected="false">
									<span class="image-area">
										<img src="assets/backend/images/icon/how-works-icon-2.png" alt="icon">
									</span>
									Choose a tournament
								</h5>
							</li>
							<li class="nav-item" role="presentation">
								<h5 class="nav-link" id="team-tab" data-bs-toggle="tab" data-bs-target="#team" role="tab" aria-controls="team" aria-selected="false">
									<span class="image-area">
										<img src="assets/backend/images/icon/how-works-icon-3.png" alt="icon">
									</span>
									Choose your amount
								</h5>
							</li>
							<li class="nav-item" role="presentation">
								<h5 class="nav-link" id="odds-tab" data-bs-toggle="tab" data-bs-target="#odds" role="tab" aria-controls="odds" aria-selected="false">
									<span class="image-area">
										<img src="assets/backend/images/icon/how-works-icon-4.png" alt="icon">
									</span>
									Play a game
								</h5>
							</li>
							<li class="nav-item" role="presentation">
								<h5 class="nav-link" id="amount-tab" data-bs-toggle="tab" data-bs-target="#amount" role="tab" aria-controls="amount" aria-selected="false">
									<span class="image-area">
										<img src="assets/backend/images/icon/how-works-icon-5.png" alt="icon">
									</span>
									Win the Prize Money
								</h5>
							</li>
					...
					<div class="col-lg-6">
						<div class="tab-content">
							<div class="tab-pane fade show active" id="sport" role="tabpanel" aria-labelledby="sport-tab">
								<h4>Select a Game</h4>
								<div class="img-area">
									<img src="assets/backend/images/process-img-1.png" alt="image">
								</div>
							</div>
							<div class="tab-pane fade" id="match" role="tabpanel" aria-labelledby="match-tab">
								<h4>Select a Tournament</h4>
								<div class="img-area">
									<img src="assets/backend/images/process-img-2.png" alt="image">
								</div>
							</div>
							<div class="tab-pane fade" id="team" role="tabpanel" aria-labelledby="team-tab">
								<h4>Select An Amount</h4>
								<div class="img-area">
									<img src="assets/backend/images/process-img-3.png" alt="image">
								</div>
							</div>
							<div class="tab-pane fade" id="odds" role="tabpanel" aria-labelledby="odds-tab">
								<h4>Play a Game</h4>
								<div class="img-area">
									<img src="assets/backend/images/process-img-4.png" alt="image">
								</div>
							</div>
							<div class="tab-pane fade" id="amount" role="tabpanel" aria-labelledby="amount-tab">
								<h4>Win the Prize Money </h4>
								<div class="img-area">
									<img src="assets/backend/images/process-img-5.png" alt="image">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="features-carousel">
				<div class="single-slide">
					<div class="slide-content">
						<div class="icon-area">
							<img src="assets/backend/images/icon/amazing-features-icon-1.png" alt="icon">
						</div>
						<h5>Safety</h5>
					</div>
				</div>
				<div class="single-slide">
					<div class="slide-content">
						<div class="icon-area">
							<img src="assets/backend/images/icon/amazing-features-icon-2.png" alt="icon">
						</div>
						<h5>Transparency</h5>
					</div>
				</div>
				<div class="single-slide">
					<div class="slide-content">
						<div class="icon-area">
							<img src="assets/backend/images/icon/amazing-features-icon-3.png" alt="icon">
						</div>
				...
				<div class="single-slide">
					<div class="slide-content">
						<div class="icon-area">
							<img src="assets/backend/images/icon/amazing-features-icon-4.png" alt="icon">
						</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 order-lg-0 order-1">
					<div class="img-area">
						<img src="assets/backend/images/more-features-image.png" alt="image">
					</div>
				</div>
				<div class="col-lg-6">
					...
					<div class="content-area">
						<div class="single-item">
							<div class="image-area">
								<img src="assets/backend/images/icon/more-features-icon-1.png" alt="image">
							</div>
							<div class="text-area">
								<h5>Pool Bets</h5>
						...
						<div class="single-item">
							<div class="image-area">
								<img src="assets/backend/images/icon/more-features-icon-2.png" alt="image">
							</div>
							<div class="text-area">
						...
						<div class="single-item">
							<div class="image-area">
								<img src="assets/backend/images/icon/more-features-icon-3.png" alt="image">
							</div>
							<div class="text-area">
			...
			<div class="row justify-content-between align-items-center">
				<div class="col-lg-5 order-lg-0 order-1">
					<div class="img-area d-rtl">
						<img src="assets/backend/images/affilliate-image.png" alt="image" class="max-un">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="section-text">
