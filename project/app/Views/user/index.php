                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="dashboard-sidebar">
                            ...
                            <div class="balance">
                                <div class="single-item">
                                    <img src="assets/backend/images/icon/dashboard-sidebar-icon-1.png" alt="images">
                                    <h5>$5135.00</h5>
                            ...
                            <div class="single-item">
                                <img src="assets/backend/images/icon/dashboard-sidebar-icon-2.png" alt="images">
                                <h5>Need Help?</h5>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="single-info">
                                            <img src="assets/backend/images/icon/user-info-icon-1.png" alt="icon">
                                            <div class="text-area">
                                                <h4>678</h4>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="single-info">
                                            <img src="assets/backend/images/icon/user-info-icon-2.png" alt="icon">
                                            <div class="text-area">
                                                <h4>91%</h4>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="single-info">
                                            <img src="assets/backend/images/icon/user-info-icon-3.png" alt="icon">
                                            <div class="text-area">
                                                <h4>22</h4>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>BTC</td>
                                                        <td>
                                                            <img src="assets/backend/images/icon/dashboard-coin-icon-1.png"
                                                                alt="icon">
                                                            0.00016556
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>USDT</td>
                                                        <td>
                                                            <img src="assets/backend/images/icon/dashboard-coin-icon-2.png"
                                                                alt="icon">
                                                            13.1072000
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>TRX</td>
                                                        <td>
                                                            <img src="assets/backend/images/icon/dashboard-coin-icon-3.png"
                                                                alt="icon">
                                                            368.033428
                                                        </td>
                                                    </tr>
                                            ...
                                            <div class="right-area">
                                                ...
                                                <div class="address-bar">
                                                    ...
                                                    <div class="input-area">
                                                        ...
                                                        <img src="assets/backend/images/icon/copy-icon.png" alt="icon">
                                                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">
                                                                        <img src="assets/backend/images/icon/buy-crypto-logo-1.png"
                                                                            alt="icon">
                                                                    </th>
                                                                    <td>5-15 mins</td>
                                                                    <td>0.003091 BTC</td>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="single-info">
                                                        <img src="assets/backend/images/icon/earned-referral-icon-1.png"
                                                            alt="icon">
                                                        <div class="text-area">
                                                            <h4>$2956.00</h4>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="single-info">
                                                        <img src="assets/backend/images/icon/earned-referral-icon-2.png"
                                                            alt="icon">
                                                        <div class="text-area">
                                                            <h4>$208.00</h4>
                                            ...
                                            <div class="table-area">
                                                <div
                                                    ...
                                                    <div class="input-area d-flex align-items-center">
                                                        ...
                                                        <img src="assets/backend/images/icon/date-icon.png" class="max-un"
                                                            alt="icon">
                                                    </div>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Maxine24</td>
                                                                <td>0.00000000BTC</td>
                                                                <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="266b475e4f4843141266414b474f4a0845494b">[email&#160;protected]</a></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">16 APR</th>
                                                                <td>Level01</td>
                                                                <td>Maxine24</td>
                                                                <td>0.00000000BTC</td>
                                                                <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c885a9b0a1a6adfafc88afa5a9a1a4e6aba7a5">[email&#160;protected]</a></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">16 APR</th>
                                                                <td>Level01</td>
                                                                <td>Maxine24</td>
                                                                <td>0.00000000BTC</td>
                                                                <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4805293021262d7a7c082f25292124662b2725">[email&#160;protected]</a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="single-area">
                                                <div class="file-upload">
                                                    <div class="img-area">
                                                        <img src="assets/backend/images/demo-profile.png" alt="icon">
                                                    </div>
                                                    <div class="right-area">
                                            ...
                                            <div class="single-area">
                                                <div class="icon-area">
                                                    <img src="assets/backend/images/icon/message-icon.png" alt="icon">
                                                </div>
                                                <p class="mdr"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7b0b131217120b4d434f3b1c161a121755181416">[email&#160;protected]</a></p>
                                                <a href="personal-details-setting.html" class="mdr">Unverified
                                                    Account</a>
                                            </div>
                                            <div class="single-area">
                                                <div class="icon-area">
                                                    <img src="assets/backend/images/icon/security-icon.png" alt="icon">
                                                </div>
                                        ...
                                        <div class="tab-pane fade show active" id="download-app" role="tabpanel"
                                            ...
                                            <div class="auth-container">
                                                ...
                                                <div class="brand d-flex align-items-center">
                                                    <a href="javascript:void(0)"><img src="assets/backend/images/app-store.png" alt="images"></a>
                                                    <a href="javascript:void(0)"><img src="assets/backend/images/google-play.png"
                                                            alt="images"></a>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="scan-qr-code" role="tabpanel"
                                            ...
                                            <div class="auth-container">
                                                ...
                                                <div class="qr-code brand">
                                                    <img src="assets/backend/images/qr-code.png" alt="images">
                                                </div>
